...
class PluginInterface(QWidget):
    def __init__(self):
        ...
        self.reg_lineedit.setPlaceholderText(
            "Ex: 0.01, 'ledoit_wolf', 'oas' (ou deixe em branco para None)"
        )
        ...
        self.advanced_rows.append(
            (self.label_transform_into, self.transform_into_combobox)
        )
        ...
        # cov_method_params
        self.label_cov_method_params = QLabel(
            "Parâmetros Covariância (cov_method_params):"
        )
        self.cov_method_params_lineedit = QLineEdit()
        self.cov_method_params_lineedit.setPlaceholderText(
            'Ex: {"method": "auto"} (ou deixe em branco para None)'
        )
        form_layout.addRow(
            self.label_cov_method_params, self.cov_method_params_lineedit
        )
        self.advanced_rows.append(
            (self.label_cov_method_params, self.cov_method_params_lineedit)
        )
        ...
        self.rank_lineedit.setPlaceholderText(
            "Ex: 5, 'auto' (ou deixe em branco para None)"
        )
        ...
        self.component_order_combobox.addItems(
            ["mutual_info", "alternate"]
        )  # Atualizado para "alternate"
        form_layout.addRow(self.label_component_order, self.component_order_combobox)
        self.advanced_rows.append(
            (self.label_component_order, self.component_order_combobox)
        )
        ...
        main_layout.addWidget(
            self.toggle_advanced_button, alignment=Qt.AlignmentFlag.AlignLeft
        )
