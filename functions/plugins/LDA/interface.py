...
class PluginInterface(QWidget):
    def __init__(self):
        ...
        self.n_components_lineedit.setPlaceholderText(
            "Ex: 1, 2 (ou deixe em branco para None)"
        )
        ...
        self.shrinkage_lineedit.setPlaceholderText(
            "Ex: 'auto', 0.5 (ou deixe em branco para None)"
        )
        ...
        self.priors_lineedit.setPlaceholderText(
            "Ex: [0.5, 0.5] (ou deixe em branco para None)"
        )
        ...
        self.advanced_rows.append(
            (self.label_store_covariance, self.store_covariance_checkbox)
        )
        ...
        self.cov_estimator_lineedit.setPlaceholderText(
            "Objeto ou deixe em branco para None"
        )
        form_layout.addRow(self.label_cov_estimator, self.cov_estimator_lineedit)
        self.advanced_rows.append(
            (self.label_cov_estimator, self.cov_estimator_lineedit)
        )
    ...
    def get_parameters(self) -> dict:
        ...
        params["covariance_estimator"] = cov_est_text if cov_est_text else None
